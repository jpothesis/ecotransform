...
import { Menu, X, Recycle, Users, ShoppingBag, MessageCircle, BarChart3, BadgeCheck, User, ArrowBigDown,  ArrowBigLeft } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4 flex-shrink-0 flex-nowrap">
            ...
            {/* ✅ UPDATED: Link Get Started to GetStarted.jsx */}
            <Link to="/get-started">
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-card rounded-lg mt-2">
              ...
              <div className="flex flex-col space-y-2 px-3 py-2">
                ...
                {/* ✅ Mobile: Get Started also linked to /get-started */}
